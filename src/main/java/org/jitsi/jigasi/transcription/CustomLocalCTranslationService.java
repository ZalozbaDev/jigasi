 ...
 * @author Daniel Zoba
 */
public class CustomLocalCTranslationService
        implements TranslationService
{
    ...
    {
        private List<List<String>> marked_input;
    
        private List<List<String>> marked_translation;
        ...
        {
            if (marked_translation.size() > 0)
            {
                List<String> tmp = marked_translation.get(0);
                if (tmp.size() > 0)
                {
                    return tmp.get(0);
                }
    ...
    private final Logger logger = Logger.getLogger(CustomLocalCTranslationService.class);

    public CustomLocalCTranslationService()
    {
    ...
    public CustomLocalCTranslationService(String apiUrl, String apiKey)
    {
        // purely for testing
        this.apiUrl = apiUrl;
        this.apiKey = apiKey;
    ...
    public static void main(String[] args)
    {
        ...
        CustomLocalCTranslationService cts = new CustomLocalCTranslationService(args[0], args[1]);
